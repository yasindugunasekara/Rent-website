...
const UserHomeFeed = () => {
  ...
  const fetchAds = async (coords, currentFilters, pageNumber, isInitial = false) => {
    try {
      ...
      const { items, hasMore: more } = await listAds({
        lat: coords.lat || undefined,
        lng: coords.lng || undefined,
        search: currentFilters.search || undefined,
        category: currentFilters.category || undefined,
        locationFilter: currentFilters.location || undefined,
          ...
          {ads.map((ad, index) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="text-gray-500 text-sm mt-2 line-clamp-2 leading-relaxed">{ad.description}</p>
              </div>
            </Link>
          ))}
